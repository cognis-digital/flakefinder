...
[![PyPI](https://img.shields.io/pypi/v/cognis-flakefinder.svg)](https://pypi.org/project/cognis-flakefinder/)
[![CI](https://github.com/cognis-digital/flakefinder/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/flakefinder/actions)
...
FLAKEFINDER exists for one job — flaky-test detector from ci history with quarantine suggestions — and does it without a SaaS bill or heavyweight setup.
...
```bash
flakefinder --version
flakefinder scan .                      # scan the current project
flakefinder scan . --format json
flakefinder scan . --fail-on high       # non-zero exit for CI gates
flakefinder mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **BuildPulse**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`flakefinder` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
