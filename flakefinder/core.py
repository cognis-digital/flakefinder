"""FLAKEFINDER core — Flaky-test detector from CI history with quarantine suggestions."""
...
RULES = [
    ("FLA-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("FLA-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("FLA-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
