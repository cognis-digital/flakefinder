#!/usr/bin/env sh
# Universal installer for flakefinder. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/flakefinder.git"
echo "Installing flakefinder ..."
...
echo "Done. Run: flakefinder --help"
